...
- (void)startReadingData:(NSArray*)customAnnotations
{
...
//                NSArray *dataAsJson = [NSJSONSerialization JSONObjectWithStream:inputStream options:0 error:nil];
                ...
                NSMutableArray *annotations = [NSMutableArray arrayWithCapacity:customAnnotations.count];
                
                
                for (Place *annotationAsCustom in customAnnotations) {
...
//                        annotation.coordinate = CLLocationCoordinate2DMake(latitudeAsString.doubleValue, longitudeAsString.doubleValue);
                        annotation.coordinate=annotationAsCustom.location.coordinate;
                        
//                        annotation.title = [annotationAsCustom valueForKeyPath:@"person.lastName"];
                        annotation.title=annotationAsCustom.name;
                        annotation.subtitle=annotationAsCustom.address;
                        
                        
                        [annotations addObject:annotation];
                        
                        if (annotations.count == customAnnotations.count) {
