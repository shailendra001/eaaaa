...
@interface CancelOrderViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
- (void)viewWillAppear:(BOOL)animated{
        ...
        [dic setObject:@"2"                                     forKey:@"order_type"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
        ...
        if(indexPath.section==0){
                ...
                for (NSDictionary* dic in arr) {
                        ...
                        view.lblQuantity.text=[NSString stringWithFormat:@"Quantity : %@",[dic objectForKey:@"product_qty"]];
                        ...
                        //      Locally price caluclation with taxes
                        
                        float actualPrice=[[dic objectForKey:@"price"] longLongValue]*[[dic objectForKey:@"product_qty"] longLongValue];
...
//                        float totalPrice=[[dic objectForKey:@"price"] longLongValue]*[[dic objectForKey:@"quantity"] longLongValue];
//                        
//                        totalAmount+=totalPrice;
                ...
                sum = [NSNumber numberWithFloat:totalAmount];
                ...
                NSDictionary *dicFirstIndexInfo = [arr objectAtIndex:0];
                ...
                cell.lblGrandTotal.text = strGrandTotalTitle;
