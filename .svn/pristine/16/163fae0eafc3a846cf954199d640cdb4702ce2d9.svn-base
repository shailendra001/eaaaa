...
@interface ReceivedOrderViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
-(void)viewWillAppear:(BOOL)animated{
        ...
        [dic setObject:@"3"                                     forKey:@"order_type"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
        ...
        if(indexPath.section==0){
             ...
             //   sum=[NSNumber numberWithFloat:(totalAmount+totalAmount * 6/100)];
