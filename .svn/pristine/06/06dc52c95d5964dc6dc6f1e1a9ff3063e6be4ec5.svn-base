...
#define kInstagramClientID @"fd952fa1589746e1a52172eb6c70553f" // enter your client id obtained by registering your application on Instagram
#define kRedirectURI @"http://www.infoicontechnologies.com" // enter the redirect uri that you mentioned while registering the client on Instagram
