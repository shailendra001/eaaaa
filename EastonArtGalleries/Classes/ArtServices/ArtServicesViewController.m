        ...
        switch (indexPath.row)
        {
                case 0:
                {
                    ...
                    if ([[EAGallery sharedClass]isLogin])
                    {
                        ...
                        [Alert alertWithMessageSimple:@"YOU MUST FIRST BE REGISTERED OR LOGIN IF YOU HAVE AN EXISTING ACCOUNT" navigation:self.navigationController gotoBack:NO animation:YES];
