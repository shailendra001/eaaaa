...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
        ...
        if(indexPath.section==0){
                ...
                // Set grand total title with included tax rate
                float tax = [[dic objectForKey:@"tax"] longLongValue];
                if (tax == 0) {
                        tax = 6;
                }
                ...
                sum = [NSNumber numberWithFloat:totalAmount];//[NSNumber numberWithFloat:(totalAmount+totalAmount*6/100)];
...
-(IBAction)showDetail:(id)sender{
        ...
        vc.from=@"back";
        vc.fromVC=kMyOrderViewController;
