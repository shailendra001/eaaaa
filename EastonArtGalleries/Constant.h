...
#define DATE_FORMAT_UTC @"yyyy-MM-dd HH:mm:ss"
...
#define FONT_DOSIS_LIGHT           FONT_HELVETICA_NEUE_LIGHT//@"Dosis-Light" //  @"Helvetica Neue-Light"
#define FONT_DOSIS_REGULAR         FONT_HELVETICA_NEUE_LIGHT//@"Dosis-Regular" //  @"Helvetica Neue-Regular"
#define FONT_DOSIS_BOLD            FONT_HELVETICA_NEUE_BOLD//@"Dosis-Bold"//  @"Helvetica Neue-Bold"

#define FONT_MONTSERRAT_SEMIBOLD   FONT_HELVETICA_NEUE_BOLD//@"Montserrat-SemiBold" //  @"Helvetica Neue-Bold"


#define FONT_HELVETICA_NEUE_LIGHT          @"Helvetica-Light"
...
#define LOGIN_WALLET_AMOUNT     @"wallet_amount"


//************** Local Server URL *************************

static NSString *const kPrefixUrl               =
@"https://www.eastonartgalleries.com";
//@"http://eastern.psgahlout.com";
static NSString *const kURL_Slider              = @"/services/home/manageHome";
static NSString *const kURL_NewArt              = @"/services/home/newArt";
static NSString *const kURL_SearchArt           = @"/services/home/searchArt";
...
static NSString *const kURL_ADD_AMOUNT          = @"/services/artservices/saveAmount";
static NSString *const kURL_AUCTION_ART_LIST    = @"/services/artservices/auction";
static NSString *const kURL_AUCTION_ART_DETAIL  = @"/services/artservices/auctionDetails";
static NSString *const kURL_GET_BIDDING_AMOUNT  = @"/services/artservices/biddingAmount";
static NSString *const kURL_PLACE_BID           = @"/services/artservices/savebid";
static NSString *const kURL_VALUATION_OF_ART    = @"/services/artservices/valuation_of_yourArtwork";
static NSString *const kURL_ART_REGISTRATION    = @"/services/artservices/saveregistration";

// Chandra Api's URL

static NSString *const kURL_BUY_CERTIFICATE    = @"/services/artservices/buycertificate";

static NSString *const kURL_GET_CERTIFICATE    = @"/services/artservices/getcertificate";

static NSString *const kURL_CHECK_EMAIL_EXISTANCE    = @"/services/user/checkEmail";

static NSString *const kURL_MEDIA_LECTURE = @"/services/artservices/mediaLecturePublicationListing";
...
static NSString *const kAuctionViewController                         = @"AuctionViewController";
static NSString *const kAuctionDetailViewController                   = @"AuctionDetailViewController";
static NSString *const kSelectionListViewController                   = @"SelectionListViewController";
static NSString *const kCurrentBiddersViewController                  = @"CurrentBiddersViewController";
static NSString *const kAddAmountViewController                       = @"AddAmountViewController";
static NSString *const kArtServicesViewController                     = @"ArtServicesViewController";
static NSString *const kValuationOfArtViewController                  = @"ValuationOfArtViewController";
static NSString *const kArtRegistrationViewController                 = @"ArtRegistrationViewController";
static NSString *const kMerchandiseViewController                 = @"MerchandiseViewController";
// Chandra VC's

static NSString *const kBuyCertificateVC                              = @"BuyCertificateVC";

static NSString *const kMediaLecturesAndPublicationVC                                = @"MediaLecturesAndPublicationVC";

static NSString *const kApplicationAndSubmittingVC                    = @"ApplicationAndSubmittingVC";

static NSString *const kTermsOfUseBecomeAsellerVC = @"TermsOfUseBecomeAsellerVC";

static NSString *const kBecomeAsellerPaymentVC = @"BecomeAsellerPaymentVC";
