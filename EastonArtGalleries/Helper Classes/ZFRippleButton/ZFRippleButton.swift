...
open class ZFRippleButton: UIButton {
    ...
    @IBInspectable open var ripplePercent: Float = 0.0 {
        didSet {
            setupRippleView()
        }
    }
    ...
    @IBInspectable open var rippleColor: UIColor = UIColor(white: 0.5, alpha: 0.3) {
        didSet {
            rippleView.backgroundColor = rippleColor
        }
    }
    
    @IBInspectable open var rippleBackgroundColor: UIColor = UIColor(white: 0.5, alpha: 0.3) {
        didSet {
