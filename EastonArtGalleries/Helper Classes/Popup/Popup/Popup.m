...
CGFloat popupDimensionWidth = 250.0f;
CGFloat popupDimensionHeight = 250.0f;
...
- (void)makeAlertPopupView {
    ...
    CGRect rect = CGRectMake(mainScreen.bounds.size.width/2 - (popupDimensionWidth/2),
                             mainScreen.bounds.size.height/2 - (popupDimensionHeight/2),
                             popupDimensionWidth,
                             popupDimensionHeight);
...
- (void)setupTitle {
    ...
    if (pTitle) {
        if (!titleLabel) {
            ...
            [titleLabel setFont:[UIFont fontWithName:FONT_MONTSERRAT_SEMIBOLD size:kPopupTitleFontSize]];
            [titleLabel setAdjustsFontSizeToFitWidth:YES];
            [titleLabel setTextAlignment:NSTextAlignmentCenter];
            [titleLabel setTextColor:[UIColor blackColor] /*#546595*/];
        }
...
- (void)setupButtons {
    ...
    if (pCancelTitle) {
        ...
        if (!cancelBtn) {
            ...
            [cancelBtn.titleLabel setFont:[UIFont fontWithName:FONT_DOSIS_REGULAR size:16.0]];
            [cancelBtn setBackgroundColor:[Alert colorFromHexString:COLOR_BUTTTON] /*#e82f2f*/];
    ...
    if (pSuccessTitle) {
        ...
        if (!successBtn) {
            ...
            [successBtn.titleLabel setFont:[UIFont fontWithName:FONT_DOSIS_REGULAR size:16.0]];
            [successBtn setBackgroundColor:[Alert colorFromHexString:COLOR_SUBSCIBE] /*#687aae*/];
...
- (void)pressAlertButton:(id)sender {
    ...
    if (self.delegate && [pTextFieldPlaceholderArray count] > 0 &&
        [self.delegate respondsToSelector:@selector(dictionary:forpopup:stringsFromTextFields:)]) {
